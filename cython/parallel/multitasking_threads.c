...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "multitasking_threads",
        "sources": [
            "multitasking_threads.pyx"
        ]
    },
    "module_name": "multitasking_threads"
}
END: Cython Metadata */
...
#define __PYX_HAVE__multitasking_threads
#define __PYX_HAVE_API__multitasking_threads
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <sys/types.h>
...
/* Module declarations from 'multitasking_threads' */
...
#define __Pyx_MODULE_NAME "multitasking_threads"
extern int __pyx_module_is_main_multitasking_threads;
int __pyx_module_is_main_multitasking_threads = 0;

/* Implementation of 'multitasking_threads' */
...
static const char __pyx_k_gots[] = "gots";
...
static const char __pyx_k_my_fd[] = "my_fd";
...
static const char __pyx_k_my_buf[] = "my_buf";
static const char __pyx_k_n_bufs[] = "n_bufs";
...
static const char __pyx_k_total_gots[] = "total_gots";
static const char __pyx_k_MemoryError[] = "MemoryError";
static const char __pyx_k_PickleError[] = "PickleError";
static const char __pyx_k_my_threadid[] = "my_threadid";
static const char __pyx_k_num_threads[] = "num_threads";
static const char __pyx_k_pyx_checksum[] = "__pyx_checksum";
static const char __pyx_k_stringsource[] = "stringsource";
static const char __pyx_k_pyx_getbuffer[] = "__pyx_getbuffer";
static const char __pyx_k_reduce_cython[] = "__reduce_cython__";
static const char __pyx_k_buf_total_size[] = "buf_total_size";
...
static const char __pyx_k_multitasking_threads[] = "multitasking_threads";
...
static PyObject *__pyx_n_s_buf_total_size;
...
static PyObject *__pyx_n_s_gots;
...
static PyObject *__pyx_n_s_multitasking_threads;
static PyObject *__pyx_kp_s_multitasking_threads_pyx;
static PyObject *__pyx_n_s_my_buf;
static PyObject *__pyx_n_s_my_fd;
static PyObject *__pyx_n_s_my_threadid;
static PyObject *__pyx_n_s_n_bufs;
...
static PyObject *__pyx_n_s_total_gots;
static PyObject *__pyx_kp_s_unable_to_allocate_array_data;
static PyObject *__pyx_kp_s_unable_to_allocate_shape_and_str;
static PyObject *__pyx_n_s_unpack;
static PyObject *__pyx_n_s_update;
static PyObject *__pyx_pf_20multitasking_threads_run(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_fds); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_20multitasking_threads_1run(PyObject *__pyx_self, PyObject *__pyx_arg_fds); /*proto*/
static PyMethodDef __pyx_mdef_20multitasking_threads_1run = {"run", (PyCFunction)__pyx_pw_20multitasking_threads_1run, METH_O, 0};
static PyObject *__pyx_pw_20multitasking_threads_1run(PyObject *__pyx_self, PyObject *__pyx_arg_fds) {
  __Pyx_memviewslice __pyx_v_fds = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  ...
  assert(__pyx_arg_fds); {
    __pyx_v_fds = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_arg_fds, PyBUF_WRITABLE); if (unlikely(!__pyx_v_fds.memview)) __PYX_ERR(0, 19, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("multitasking_threads.run", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_20multitasking_threads_run(__pyx_self, __pyx_v_fds);
...
static PyObject *__pyx_pf_20multitasking_threads_run(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_fds) {
  Py_ssize_t __pyx_v_idx;
  Py_ssize_t __pyx_v_i;
  int __pyx_v_n_bufs;
  uint64_t __pyx_v_buf_size;
  uint64_t __pyx_v_buf_total_size;
  uint64_t __pyx_v_offsets[0x3E8];
  uint64_t __pyx_v_read_size;
  int64_t __pyx_v_gots[0x3E8];
  int __pyx_v_dones[0x3E8];
  uint64_t __pyx_v_total_gots[0x3E8];
  CYTHON_UNUSED int __pyx_v_n_tasks;
  char *__pyx_v_buf;
  CYTHON_UNUSED int __pyx_v_num_threads;
  char *__pyx_v_my_buf;
  int __pyx_v_my_fd;
  int __pyx_v_my_threadid;
 ...
 */
  __pyx_v_n_bufs = (__pyx_v_fds.shape[0]);

  /* "multitasking_threads.pyx":25
 *     # Buffer settings
 *     cdef int n_bufs = fds.shape[0]
 *     cdef uint64_t buf_size = 100000000             # <<<<<<<<<<<<<<
 *     cdef uint64_t buf_total_size = buf_size * n_bufs
 ...
 */
  __pyx_v_buf_size = 0x5F5E100;

  /* "multitasking_threads.pyx":26
 *     cdef int n_bufs = fds.shape[0]
 *     cdef uint64_t buf_size = 100000000
 *     cdef uint64_t buf_total_size = buf_size * n_bufs             # <<<<<<<<<<<<<<
 *     cdef uint64_t offsets[1000]
 * 
 */
  __pyx_v_buf_total_size = (__pyx_v_buf_size * __pyx_v_n_bufs);

  /* "multitasking_threads.pyx":30
 * 
 *     # Read settings
 ...
 *     cdef int dones[1000]
 */
  __pyx_v_read_size = 0x4C4B40;

  /* "multitasking_threads.pyx":36
 * 
 ...
 *         dones[i] = 0
 */
  __pyx_v_buf = ((char *)malloc(__pyx_v_buf_total_size));

  /* "multitasking_threads.pyx":40
 *     # Allocate buffers and initialize done flags
 *     cdef char* buf = <char *> malloc(buf_total_size)
 *     for i in range(n_bufs):             # <<<<<<<<<<<<<<
 *         dones[i] = 0
 *         gots[i] = 0
 */
  __pyx_t_1 = __pyx_v_n_bufs;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "multitasking_threads.pyx":41
 *     cdef char* buf = <char *> malloc(buf_total_size)
 *     for i in range(n_bufs):
 *         dones[i] = 0             # <<<<<<<<<<<<<<
 *         gots[i] = 0
 *         total_gots[i] = 0
 */
    (__pyx_v_dones[__pyx_v_i]) = 0;

    /* "multitasking_threads.pyx":42
 *     for i in range(n_bufs):
 *         dones[i] = 0
 *         gots[i] = 0             # <<<<<<<<<<<<<<
 *         total_gots[i] = 0
 ...
 */
    (__pyx_v_gots[__pyx_v_i]) = 0;

    /* "multitasking_threads.pyx":43
 *         dones[i] = 0
 *         gots[i] = 0
 *         total_gots[i] = 0             # <<<<<<<<<<<<<<
 *         offsets[i] = i * buf_size
 * 
 */
    (__pyx_v_total_gots[__pyx_v_i]) = 0;

    /* "multitasking_threads.pyx":44
 *         gots[i] = 0
 *         total_gots[i] = 0
 *         offsets[i] = i * buf_size             # <<<<<<<<<<<<<<
 * 
 ...
 */
    (__pyx_v_offsets[__pyx_v_i]) = (__pyx_v_i * __pyx_v_buf_size);
  }

  /* "multitasking_threads.pyx":47
 * 
 *     # Enables dynamic adjustment of the number of threads
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel private(__pyx_v_idx, __pyx_v_my_buf, __pyx_v_my_fd, __pyx_v_my_threadid, __pyx_v_num_threads) private(__pyx_t_1, __pyx_t_3, __pyx_t_4, __pyx_t_5) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb) num_threads(__pyx_v_n_bufs)
            #endif /* _OPENMP */
            {
                #ifdef _OPENMP
                #ifdef WITH_THREAD
                ...
                __pyx_v_my_buf = ((char *)1);
                __pyx_v_my_fd = ((int)0xbad0bad0);
                __pyx_v_my_threadid = ((int)0xbad0bad0);
                __pyx_v_num_threads = ((int)0xbad0bad0);

                /* "multitasking_threads.pyx":54
 *     with nogil, parallel(num_threads=n_bufs):
 *     #for i in range(6):
 *         num_threads = openmp.omp_get_num_threads()             # <<<<<<<<<<<<<<
 ...
 */
                ...
                __pyx_t_1 = 0;
                #endif
                __pyx_v_my_threadid = __pyx_t_1;

                /* "multitasking_threads.pyx":58
 *         #my_threadid = i
 *         #idx = int(my_threadid / n_tasks)
 *         idx = my_threadid             # <<<<<<<<<<<<<<
 *         my_fd = fds[idx]
 * 
 */
                __pyx_v_idx = __pyx_v_my_threadid;

                /* "multitasking_threads.pyx":59
 *         #idx = int(my_threadid / n_tasks)
 *         idx = my_threadid
 *         my_fd = fds[idx]             # <<<<<<<<<<<<<<
 * 
 ...
 */
                ...
                __pyx_t_1 = -1;
                if (__pyx_t_4 < 0) {
                  __pyx_t_4 += __pyx_v_fds.shape[0];
                  if (unlikely(__pyx_t_4 < 0)) __pyx_t_1 = 0;
                } else if (unlikely(__pyx_t_4 >= __pyx_v_fds.shape[0])) __pyx_t_1 = 0;
                if (unlikely(__pyx_t_1 != -1)) {
                  __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_1);
                  __PYX_ERR(0, 59, __pyx_L10_error)
                }
                __pyx_v_my_fd = (*((int *) ( /* dim=0 */ (__pyx_v_fds.data + __pyx_t_4 * __pyx_v_fds.strides[0]) )));

                /* "multitasking_threads.pyx":67
 *         if True:
 *             # Reading thread
 *             while dones[idx] == 0:             # <<<<<<<<<<<<<<
 ...
 */
                while (1) {
                  __pyx_t_5 = (((__pyx_v_dones[__pyx_v_idx]) == 0) != 0);
                  if (!__pyx_t_5) break;

                  /* "multitasking_threads.pyx":69
 *             while dones[idx] == 0:
 *                 # Check end of my block
 *                 if offsets[idx] + read_size > buf_size * (idx + 1):             # <<<<<<<<<<<<<<
 *                     offsets[idx] = 0
 * 
 */
                  __pyx_t_5 = ((((__pyx_v_offsets[__pyx_v_idx]) + __pyx_v_read_size) > (__pyx_v_buf_size * (__pyx_v_idx + 1))) != 0);
                  if (__pyx_t_5) {

                    /* "multitasking_threads.pyx":70
 *                 # Check end of my block
 *                 if offsets[idx] + read_size > buf_size * (idx + 1):
 *                     offsets[idx] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
                  __pyx_v_my_buf = (__pyx_v_buf + (__pyx_v_offsets[__pyx_v_idx]));

                  /* "multitasking_threads.pyx":73
 * 
 *                 my_buf = buf + offsets[idx]
 *                 gots[idx] = read(my_fd, my_buf, read_size)             # <<<<<<<<<<<<<<
 *                 total_gots[idx] += gots[idx]
 *                 if gots[idx] <= 0:
 */
                  (__pyx_v_gots[__pyx_v_idx]) = read(__pyx_v_my_fd, __pyx_v_my_buf, __pyx_v_read_size);

                  /* "multitasking_threads.pyx":74
 *                 my_buf = buf + offsets[idx]
 *                 gots[idx] = read(my_fd, my_buf, read_size)
 *                 total_gots[idx] += gots[idx]             # <<<<<<<<<<<<<<
 *                 if gots[idx] <= 0:
 ...
 */
                  ...
                  (__pyx_v_total_gots[__pyx_t_3]) = ((__pyx_v_total_gots[__pyx_t_3]) + (__pyx_v_gots[__pyx_v_idx]));

                  /* "multitasking_threads.pyx":75
 *                 gots[idx] = read(my_fd, my_buf, read_size)
 *                 total_gots[idx] += gots[idx]
 *                 if gots[idx] <= 0:             # <<<<<<<<<<<<<<
 *                     dones[idx] = 1
 *                 else:
 */
                  __pyx_t_5 = (((__pyx_v_gots[__pyx_v_idx]) <= 0) != 0);
                  if (__pyx_t_5) {

                    /* "multitasking_threads.pyx":76
 *                 total_gots[idx] += gots[idx]
 *                 if gots[idx] <= 0:
 *                     dones[idx] = 1             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
                  /*else*/ {
                    __pyx_t_3 = __pyx_v_idx;
                    (__pyx_v_offsets[__pyx_t_3]) = ((__pyx_v_offsets[__pyx_t_3]) + (__pyx_v_gots[__pyx_v_idx]));
                  }
                  __pyx_L15:;
                }
                goto __pyx_L17;
 ...
 */
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_fds, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "multitasking_threads.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "multitasking_threads.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "multitasking_threads.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "multitasking_threads._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_multitasking_threads(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_multitasking_threads},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    __pyx_k_Performing_two_tasks_1_Reading, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_buf_total_size, __pyx_k_buf_total_size, sizeof(__pyx_k_buf_total_size), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_gots, __pyx_k_gots, sizeof(__pyx_k_gots), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_multitasking_threads, __pyx_k_multitasking_threads, sizeof(__pyx_k_multitasking_threads), 0, 0, 1, 1},
  {&__pyx_kp_s_multitasking_threads_pyx, __pyx_k_multitasking_threads_pyx, sizeof(__pyx_k_multitasking_threads_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_my_buf, __pyx_k_my_buf, sizeof(__pyx_k_my_buf), 0, 0, 1, 1},
  {&__pyx_n_s_my_fd, __pyx_k_my_fd, sizeof(__pyx_k_my_fd), 0, 0, 1, 1},
  {&__pyx_n_s_my_threadid, __pyx_k_my_threadid, sizeof(__pyx_k_my_threadid), 0, 0, 1, 1},
  {&__pyx_n_s_n_bufs, __pyx_k_n_bufs, sizeof(__pyx_k_n_bufs), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_total_gots, __pyx_k_total_gots, sizeof(__pyx_k_total_gots), 0, 0, 1, 1},
 ...
 *     cdef Py_ssize_t idx, i
 */
  __pyx_tuple__19 = PyTuple_Pack(18, __pyx_n_s_fds, __pyx_n_s_fds, __pyx_n_s_idx, __pyx_n_s_i, __pyx_n_s_n_bufs, __pyx_n_s_buf_size, __pyx_n_s_buf_total_size, __pyx_n_s_offsets, __pyx_n_s_read_size, __pyx_n_s_gots, __pyx_n_s_dones, __pyx_n_s_total_gots, __pyx_n_s_n_tasks, __pyx_n_s_buf, __pyx_n_s_num_threads, __pyx_n_s_my_buf, __pyx_n_s_my_fd, __pyx_n_s_my_threadid); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(1, 0, 18, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_multitasking_threads_pyx, __pyx_n_s_run, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 19, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initmultitasking_threads(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initmultitasking_threads(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_multitasking_threads(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_multitasking_threads(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_multitasking_threads(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'multitasking_threads' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_multitasking_threads(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("multitasking_threads", __pyx_methods, __pyx_k_Performing_two_tasks_1_Reading, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_multitasking_threads) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "multitasking_threads")) {
      if (unlikely(PyDict_SetItemString(modules, "multitasking_threads", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef Py_ssize_t idx, i
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_20multitasking_threads_1run, NULL, __pyx_n_s_multitasking_threads); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_run, __pyx_t_1) < 0) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "multitasking_threads.pyx":1
 * """             # <<<<<<<<<<<<<<
 * Performing two tasks:
 *     1. Reading files to fill out buffers
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init multitasking_threads", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init multitasking_threads");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
