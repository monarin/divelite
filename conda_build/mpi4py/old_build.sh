export PATH=/reg/neh/home/monarin/tmp/4.0.0-psbuild-rhel7/bin:$PATH
which mpicc
...
echo 'export LD_LIBRARY_PATH=/reg/neh/home/monarin/tmp/4.0.0-psbuild-rhel7/lib' >> $ACTIVATE
echo 'export PATH=/reg/neh/home/monarin/tmp/4.0.0-psbuild-rhel7/bin:$PATH' >> $ACTIVATE
